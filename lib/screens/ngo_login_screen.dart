...
import 'package:good_deed/screens/ngo_signup_screen.dart';
...
class NgoLoginScreen extends StatefulWidget {
  ...
  @override
  State<NgoLoginScreen> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<NgoLoginScreen> {
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    gradient: const LinearGradient(
                      colors: [
                        ourColor,
                        Color.fromRGBO(19, 129, 141, 1), // Light Blue
                      ],
